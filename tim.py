...
class zefoy:
    ...
    def __title_loop(self):
        if name == 'nt':
            while True:
                ...
                system('title Zefoy Bot by @Trường PC ^| Likes: %s Views: %s Shares: %s ^| %s ^| mode: hearts' % (
    ...
    @staticmethod
    def startup():
        system('cls' if name == 'nt' else ''); system('title Like Bot by @Trường PC ^| starting...')
...
|_   _| ((_)(_))(  ((_) _(_/(  (()(_) | _ \((/ __| 
  ...
  |_|  |_|   \_,_|\___/|_||_| \__, |  |_|    \___| 
                              |___/                
   \n                      Toll TikTOk by Trường PC   ''') + Col.reset); print("\n\n")
